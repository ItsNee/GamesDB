    ...
    <body id="page-top">
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">Your go-to for Games.</h1>
                            <p class="lead fw-normal text-muted mb-5">Get all your games from one centralized platform!</p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="masthead-device-mockup">
                            ...
                            <img class="floatAboveEverything1" src="assets/img/pcSetup.png" width="100%" alt="Gaming Setup">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <aside class="text-center bg-gradient-primary-to-secondary">
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        <div class="h2 fs-1 text-white mb-4">"Never have to deal with multi platform issues ever again!"</div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-4 order-lg-0">
                        ...
                        <div class="features-device-mockup">
                            ...
                            <rect x="-32.54" y="78.39" width="305.92" height="84.05" rx="42.03" transform="translate(-49.88 120.42) rotate(-45)"></rect></svg
                            ><svg class="shape-2 d-none d-sm-block" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="50"></circle></svg>
                            <img class="floatAboveEverything2" src="assets/img/gta5Cover.jpeg" width="100%" alt="GTA5 Cover Pic">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary-to-secondary p-4">
                        <h5 class="modal-title font-alt text-white" id="signInModalLabel">Sign in !</h5>
                        <button class="btn-close btn-close-white" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body border-0 p-4">
                        <form id="signInForm" action="processSignIn.php" method="POST" enctype="multipart/form-data">
                            <!-- userName input-->
        ...
        <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary-to-secondary p-4">
                        <h5 class="modal-title font-alt text-white" id="registerModalLabel">Register !</h5>
                        <button class="btn-close btn-close-white" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body border-0 p-4">
                        <form id="registerForm" name="registerForm" action="processRegister.php" method="POST" enctype="multipart/form-data">
                            <!-- userName input-->
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="confirmPassword" name="confirmPassword" type="password" placeholder="Enter your password again..." data-sb-validations="required" />
