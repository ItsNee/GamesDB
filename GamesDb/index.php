                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="masthead-device-mockup">
                            ...
                            <img class="floatAboveEverything" src="assets/img/pcSetup.png" alt="Gaming Setup">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body border-0 p-4">
                        <form id="signInForm" action="" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="password" type="text" placeholder="Enter your password again..." data-sb-validations="required" />
